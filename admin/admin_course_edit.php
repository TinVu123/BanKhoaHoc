...
<body>
    ...
    <div class="main">
        ...
        <section class="container-box">
            <form action="processing/edit_course.php?id=<?php $id_course =$_GET['id']; echo $id_course;?>" method="post" enctype="multipart/form-data">
        ...
        <section class="container-box">
            <form action="processing/edit_course.php?id=<?php $id_course =$_GET['id']; echo $id_course;?>"  method="post" enctype="multipart/form-data">
                ...
                <div class="flex">
                    <div class="div1">
                        <?php 
                            ...
                            ?>
                                        ...
                                        <input type="text" name="name_lesson" value="<?php echo $row['title'];?>" class="box" id="name-lesson" required placeholder="Nhập tên bài học">
                    ...
                    <div class="div2">
                        <video id="video" style="display:block;" preload="block" src="../uploaded_video/<?php echo $row['video']?>" controls></video>
                    </div> 
                </div>
                    ...
                    <button style="display: none;" type="submit" name="submit_video" class="btn btn-add" id="btn-add-lesson">Thêm</button>
            
                                        
                            <?php
                                    }
                                } else {
                                    echo "<p>Không tìm thấy video với ID được cung cấp.</p>";
                                }
                            } else {
                            ?>
                                <label for="name_lesson">Tên bài học:</label>
                                <input type="text" name="name_lesson" value="" class="box" id="name-lesson" required placeholder="Nhập tên bài học">
                                <label for="video">Video</label>
                                <input type="file" id="input" name="input_video" accept="video/mp4, video/mov">
                                </div>
                            <div class="div2">
                        ...
                        <tr>
                            ...
                            <td>
                                <!--  button sẽ gửi lên url và mât id -->
                                    <a style="width:60px" class="btn btn-delete" href="processing/edit_course.php?id=<?php $course_id = $_GET['id']; echo htmlspecialchars($course_id);?>&delete_video_id=<?php echo htmlspecialchars($row['id']); ?>"  onclick="return confirm('Delete this video?');">Xoá</a>
                            </td>
                            <td > 
